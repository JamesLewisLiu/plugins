...
export function register() {
  ...
  R.Config('shop_championship_phase', {
    name: 'Shop Championship phase',
    desc: 'active accepts play results; completed shows the final Ranker board and qualifying gold HUD.',
    type: 'string',
    default: 'active',
